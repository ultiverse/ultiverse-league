...
export interface JerseyIconProps extends Omit<SvgIconProps, 'color'> {
  color?: string;
}

export function JerseyIcon({ color, ...props }: JerseyIconProps) {
  return (
    <SvgIcon htmlColor={color} {...props} viewBox="0 0 295.526 295.526">
      {/* Jersey SVG paths from public/jersey.svg */}
